...
While you have Kronos open, find all the textures exported by Wraith or Lime and drop them into Kronos' image converter to convert them to .TIFF, the only image format Black Ops 3 supports.
