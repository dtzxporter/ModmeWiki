...
In early days of zombie modding, setup files would have to be placed manually, but now most of that is done for you in the several script placers available. I highly recommend [[Script Placer Z|todo]]. Requires registration. 
