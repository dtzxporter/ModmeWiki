...
{% endraw %}{% endhighlight %}
<br /><br /><br /><p style="text-align:left;"></p><p style="text-align:left;">Next, Navigate to: share/raw/gamedata/weapons/zm/zm_levelcommon_weapons.csv</p><p style="text-align:left;">Add the following text to the bottom:</p>{% highlight php %}{% raw %}
bo1_rpk,bo1_rpk_upgraded,,5000,lmg,,,,,TRUE,FALSE,FALSE,,,FALSE,TRUE,lmg,,,

{% endraw %}{% endhighlight %}
<br /><br /><br /><p style="text-align:left;"></p><p style="text-align:left;">Finally, In the launcher, right click on your map name, and click &quot;Edit Zone File&quot;, and add this text to the bottom:</p>{% highlight php %}{% raw %}
weapon,bo1_rpk_zm
