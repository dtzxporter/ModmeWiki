...
{% endraw %}{% endhighlight %}
<br /><span style="font-size:1.6em;">mapname.[COLOR=rgb(251, 160, 38)]zone[/COLOR]:</span><br />{% highlight php %}{% raw %}
include,elemental_bow_new
{% endraw %}{% endhighlight %}
<br /><span style="font-size:1.6em;">[COLOR=rgb(251, 160, 38)]GSC [/COLOR]and [COLOR=rgb(251, 160, 38)]CSC[/COLOR]:</span><br />{% highlight php %}{% raw %}
