...
<p>Basically give your bruhsmodels the KVP &quot;index&quot; and value any integer. start at 0. So the first brush to go has the value 0, second has 1, 3rd has 2... If you want to shoot twice to remove 1 brush, just skip a number so first is 0, second is 2, third is 3...<br /><br /><br />{% highlight php %}
function gun_ammo_thing()
{
trig = GetEnt("whatever trigger","targetname");
