...
<p>Reply By: Scoper<br /><blockquote><em>Abnormal202</em><p style="text-align:left;">Did you put them in your user_aliases or did you make a new alias? also, can you post the code of the alias?</p></blockquote><p style="text-align:left;">Copied the old alias that had this</p><p style="text-align:left;"></p>{% highlight php %}
