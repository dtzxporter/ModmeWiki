...
<p>Reply By: ByKris<br /><blockquote><em>natesmithzombies</em>As usual I dont have time to test but give this a shot: <br /><br /><br /><br />Instructions<br /><br />--------------<br /><br />1) Add this to the bottom of mapname.gsc<br /><br />{% highlight php %}{% raw %}
function teleport_every_Xrounds( rounds_to_tele )
{
	level endon( "intermission" ); 
	level.rand_tele_spots = struct::get_array( "rand_tele_struct", "targetname" ); 
