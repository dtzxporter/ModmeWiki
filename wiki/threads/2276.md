...
{% endraw %}{% endhighlight %}
 <br /><p style="text-align:left;"><span style="color:#ff6600;">Step 2: Copy</span></p><br />{% highlight php %}{% raw %}
thread perk_ee();

{% endraw %}{% endhighlight %}
 <br /><p style="text-align:left;"><span style="color:#ff6600;">and Paste Under</span></p><br />{% highlight php %}{% raw %}
level thread zm_zonemgr::manage_zones( init_zones );

{% endraw %}{% endhighlight %}
 <br /><p style="text-align:left;"><span style="color:#ff6600;">Should look like this:</span></p><br />{% highlight php %}{% raw %}
