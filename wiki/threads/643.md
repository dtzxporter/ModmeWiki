...
<p>Reply By: Exofile<br />I&#39;m not a scripter, but from what I know, try adding this into the teleport script, just have it not activate if the teleporter already has been used?<br /><br />{% highlight php %}
level util::set_lighting_state( 0 );{% endhighlight %}
</p>
