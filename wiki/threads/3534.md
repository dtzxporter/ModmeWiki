...
scriptparsetree,scripts/zm/_zm_lost_n_found.csc{% endhighlight %}
...
<br />Everything between the requires and <pre>function LUI.createMenu.T7Hud_zm_factory(InstanceRef)</pre><br /><br />Everything between the START and END LnF comments in <pre>function LUI.createMenu.T7Hud_zm_factory(InstanceRef)</pre><br /><br />In <pre>local function HudCloseCallback(SenderObj)</pre>:<br />{% highlight php %}
