...
<p>Thread By: Stonermagoo420<br />It was working the other day then i goto compile, link and launcher says this <br />{% highlight php %}
...
^1
^1-------------^
^1ERR(0) scripts/zm/_zm_perk_doubletap2.gscc (1,14)  : syntax error, unexpected TOKEN_IDENTIFIER, expecting $end :  {% endhighlight %}
