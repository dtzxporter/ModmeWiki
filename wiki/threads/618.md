...
<br /><br /><br />You could paste this code at the bottom of mapname.gsc and then call is like this in the &quot;function main&quot; of your mapname.gsc:<br /><br />{% highlight php %}
function main()
{
...
<br /><br /><br />Step 2) Paste this under <br /><br />{% highlight php %}
function main()
{{% endhighlight %}
<br />in your mapname.gsc<br /><br />{% highlight php %}
thread new_zombie_health(5); {% endhighlight %}
