...
{% endraw %}{% endhighlight %}
<br /> <br /> <br /> <br /><strong><span style="text-decoration: underline"><span style="color:#ff6633;">Disable the craftables you dont want to use</span></span></strong><br /><br /><br /><br /><br /> <br /> <br />{% highlight php %}{% raw %}
