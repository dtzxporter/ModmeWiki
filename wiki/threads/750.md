...
<p>Reply By: MJPW<br /><p style="text-align:left;">Here is the give, take, and think.</p><p style="text-align:left;"></p>{% highlight php %}
...
<p>Reply By: natesmithzombies<br /><blockquote><em>MJPW</em><p style="text-align:left;">Here is the give, take, and think.</p><p style="text-align:left;"></p>{% highlight php %}
function give_custom_perk()
