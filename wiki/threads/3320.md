...
---
<strong>Qelifern</strong>:

[SIZE=5]First of all, this is the first time I&#39;m releasing something this big, it has taken a long time to even get to this point with these staffs.
Hopefully everything is included in the download, however if something is missing, point it out in the comments.[/SIZE]
...
<a href="">https://www.t7mods.com/viewtopic.php?f=4&amp;t=9</a>

Almost all the scripts come from or originated from Scobalula&#39;s Cerberus so many thanks to you sir.

[SIZE=5]Instructions for installation and upgrade steps are also included.[/SIZE]
...
[SIZE=6][FONT=courier new]&quot;Don&#39;t be a jerk&quot;, please if you use this to create content, give credit where credit is due.[/FONT][/SIZE]
...
[FONT=trebuchet ms][SIZE=5]If you run into troubles when installing, make sure you read through all the steps and see if you missed something before commenting.[/SIZE][/FONT]

- -----------------------------------------

                   [SIZE=5][FONT=book antiqua]<a href="'https://mega.nz/file/urx0QYhD#CUpJ_bc-r0ovLhYaaZMvrKhkAkbqRPgHklrxilVZAJ0'">DOWNLOAD</a>  v1.0.1[/FONT][/SIZE]

- -----------------------------------------

[SIZE=5]<strong>Credits:</strong>[/SIZE]
[FONT=book antiqua]AllModz
AndyWhelen
Azsry
BluntStuffy
Collie
...
Zeroy
alexbgt
thezombieproject[/FONT]

---
<strong>Pepergogo</strong>:

Thank you soooo much for this! &#128588;

---
<strong>brack5501</strong>:

What a great job brother &#128516; I really loved seeing the progress of your work! crack !! &lt;3

---
<strong>ProfessorWeeWoo</strong>:
...
---
<strong>DestinyDobby</strong>:

my impact fx looks like this <a href="">https://gyazo.com/d4615527ed2f299aefee5b2c1ef61d96</a> i have reinstalled harry&#39;s fx pack like 3 times, but it is still just a low quality cloud of smoke, any ideas?

---
<strong>Qelifern</strong>:

<blockquote>my impact fx looks like this <a href="">https://gyazo.com/d4615527ed2f299aefee5b2c1ef61d96</a> i have reinstalled harry&#39;s fx pack like 3 times, but it is still just a low quality cloud of smoke, any ideas?
</blockquote>
I get that aswell, I think it&#39;s to do with SSI settings in Radiant, not sure though.

---
<strong>panzersoldat</strong>:

How do I get the genesis spawner actor ?

---
<strong>Philip-p</strong>:

link for the fx arent working cant download them

---
<strong>CaramelFudge</strong>:
