...
<p>Thread By: tbone-5<br /> i cant figure out how to give natesmiths empty perk bottle to the player from a shootable objects script &amp; have it be to all players. right now i have this set can&#39;t figure out how to make it give the drop &amp; it would need give it to all players.<br /><br />{% highlight php %}
...
<p>Reply By: natesmithzombies<br /><blockquote><em>tbone-5</em>okay i added the trigger with the target name &amp; nothing happeneds when i shoot it</blockquote><br /><br />Try adding this at the bottom of main_shootable_perk_slot: <br /><br />{% highlight php %}
wait(20); 
iprintlnbold( "There are "+trigs.size+" triggers in the map" ); {% endhighlight %}
...
<p>Reply By: tbone-5<br /><blockquote><em>natesmithzombies</em><blockquote><em>tbone-5</em>okay i added the trigger with the target name &amp; nothing happeneds when i shoot it</blockquote><br /><br />Try adding this at the bottom of main_shootable_perk_slot: <br /><br />{% highlight php %}
wait(20); 
iprintlnbold( "There are "+trigs.size+" triggers in the map" ); {% endhighlight %}
...
<p>Reply By: natesmithzombies<br /><blockquote><em>tbone-5</em><blockquote><em>natesmithzombies</em><blockquote><em>tbone-5</em>okay i added the trigger with the target name &amp; nothing happeneds when i shoot it</blockquote><br /><br />Try adding this at the bottom of main_shootable_perk_slot: <br /><br />{% highlight php %}
wait(20); 
iprintlnbold( "There are "+trigs.size+" triggers in the map" ); {% endhighlight %}
...
<p>Reply By: tbone-5<br /><blockquote><em>natesmithzombies</em><blockquote><em>tbone-5</em><blockquote><em>natesmithzombies</em><blockquote><em>tbone-5</em>okay i added the trigger with the target name &amp; nothing happeneds when i shoot it</blockquote><br /><br />Try adding this at the bottom of main_shootable_perk_slot: <br /><br />{% highlight php %}
wait(20); 
iprintlnbold( "There are "+trigs.size+" triggers in the map" ); {% endhighlight %}
