...
<p>Reply By: mathfag<br /> <br />Zone<br />{% highlight php %}
fx,fx/path.efx{% endhighlight %}
 <br /> <br /> <br />Top of script<br />{% highlight php %}
#precache( "fx", "fx/path");{% endhighlight %}
...
trig Delete();
 ...
 <br />OR if you want to reuse the trig<br />{% highlight php %}
function fxtrigger()
{
trig = GetEnt("fx_trigger","targetname");
while(1)
...
<p>Reply By: mathfag<br /><blockquote><em>KillJoyYT</em><br />I&#39;m sorry for the confusion guys. I would rather have trig damage.   I put the code in my gsc and  idk   im confused with what kvps I need and what variables I have to change</blockquote><br /> In function main:<br />{% highlight php %}
thread damage_trig();{% endhighlight %}
 <br /> <br />at the bottom:<br />{% highlight php %}
...
<p>Reply By: KillJoyYT<br />wow you guys are awesome thank you<br /> <br /> <br />one more question!<br /> <br />I change &quot;powerup_on_solo&quot; to another fx thats in my fx browser?<br /> <br /> <br />so for fire would it be this?<br /> <br /> <br />{% highlight php %}
function damage_trig()
{
trig = GetEnt("d_trig","targetname");
trig waittill( "damage" );
...
Level._effect effects are effects that are defined somewhere like in _zm.gsc{% endhighlight %}
