...
<br />Also replace <pre>determine_cost( localClientNum, rounds, buys, firesale )</pre> in scripts/zm/_zm_bgb_machine.csc with this:<br />{% highlight php %}
...
<p><blockquote>Replace <pre>bgb_determine_cost(player)</pre> in scripts/zm/_zm_bgb_fix.gsc with this:<br />{% highlight php %}
