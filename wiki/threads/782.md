...
{% endhighlight %}
<br /><br /><br /><p style="text-align:left;">Step 2) Add this to your function main in your mapname.gsc:</p>{% highlight php %}
ammo_matic();
{% endhighlight %}
<br /><br /><br /><p style="text-align:left;">Step 3) Add this to the top of your mapname.gsc: </p>{% highlight php %}
...
ERR(6E) scripts/zm/zm_town.gsc (165,1) : Compiler Internal Error : Uninitialized local variable &#39;player&#39;
{% endhighlight %}
<br /></blockquote><p style="text-align:left;">This is what was on line 165</p><p style="text-align:left;"></p><p style="text-align:left;">{% highlight php %}
self waitill( "trigger", player );
{% endhighlight %}
<br /></p></p>
...
ERR(6E) scripts/zm/zm_town.gsc (165,1) : Compiler Internal Error : Uninitialized local variable &#39;player&#39;
{% endhighlight %}
<br /></blockquote><p style="text-align:left;">This is what was on line 165</p><p style="text-align:left;"></p>{% highlight php %}
self waitill( "trigger", player );
{% endhighlight %}
