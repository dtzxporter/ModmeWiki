...
<p>Reply By: meepmeep<br />Nope. <br /> <br />The code is still in the script, as well for the downloaded DLL. <br /> <br />{% highlight php %}
...
<p>Reply By: meepmeep<br />i already did that sir. i redownloaded the dll and placed it in the {% highlight php %}
&lt;bo3_root&gt;/bin/&lt;/bo3_root&gt;{% endhighlight %}
...
^1ERROR: sound aliases failed to load
 ...
 ["E:\SteamLibrary\steamapps\common\Call of Duty Black Ops III\bin\linker_modtools.exe" -language english -modsource -spawnedchild -localized zm_hardhat]{% endhighlight %}
</p>
...
<p>Reply By: meepmeep<br />i have no mistyped content in it. As you provided in the demo how it should be placed, i placed in the ex-ext way as you described. <br /> <br />{% highlight php %}
{
 "Name" : "zm_hardhat",
 "GameMode" : "mpl",
 "IsCommon" : false,
