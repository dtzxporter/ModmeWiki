...
my_awesome_function();{% endhighlight %}
 <br /> <br />if we place this line inside a function that we know will be run before the start of the game, we can effectively call it:<br /> <br />{% highlight php %}
function main()
{
    zm_usermap::main();
