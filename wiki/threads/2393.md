...
{% endhighlight %}
 <br />You can use RDV&#39;s &quot;Acoustix&quot; app to assist with this, which includes SZC editing:<br /> <br /><a href="https://wiki.ardivee.com/article/acoustix/">Download</a> <br /> <br /> <br />&lt;h3&gt;Step 3&lt;/h3&gt;<br />&lt;hr&gt; <br />Open your map&#39;s Zone File (right click on it in Launcher and click &quot;Edit Zone File&quot;) and add the following line:<br /> <br /> <br />{% highlight php %}
stringtable,gamedata/audio/zm/zm_zod_vox.csv{% endhighlight %}
 <br />&lt;h3 style=&quot;text-align:left;&quot;&gt;Step 4&lt;/h3&gt;<br />&lt;hr&gt; <br />Open your map&#39;s GSC file usually located in &quot;Call of Duty Black Ops III\usermaps\zm_map_name\scripts\zm&quot;.<br /> <br />Once open find the line:<br /> <br />{% highlight php %}
zm_usermap::main();
{% endhighlight %}
 <br />Add this above it:<br /> <br />{% highlight php %}
callback::on_spawned( &amp;give_player_character );{% endhighlight %}
 <br />Then find the line:<br /> <br />{% highlight php %}
...
function add_zm_vox()
{
 ...
 <br />And then finally, add this line below the above function:<br /> <br />{% highlight php %}
