...
<p>Reply By: Hero115<br /><blockquote>Also at the top of your mapname.gsc add:<br /><br />{% highlight php %}
#insert scripts\zm\_zm_perks.gsh;{% endhighlight %}
...
<p>Reply By: natesmithzombies<br /><blockquote><em>Hero115</em><blockquote>Also at the top of your mapname.gsc add:<br /><br />{% highlight php %}
#insert scripts\zm\_zm_perks.gsh;{% endhighlight %}
