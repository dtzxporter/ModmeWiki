...
{% endraw %}{% endhighlight %}
to [COLOR=rgb(184, 49, 47)]walk [/COLOR]in [COLOR=rgb(243, 121, 52)]function witch_init(s_struct, ang)[/COLOR]<br /><br /><br />To make the ghost spawn infinitely you can make a basic loop like so:<br />{% highlight php %}{% raw %}
while(1)
    {
