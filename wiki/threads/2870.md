...
<p>You don&#39;t actually need this code to have them spawn in: <pre>zm_buried_ghost::spawn_witch(health);</pre><br /><br />However, you could do something like this:<br /><br />{% highlight php %}
function witch()
{
...
// Make sure to "thread witch();" in your "function main()"{% endhighlight %}
