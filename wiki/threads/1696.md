...
<p>Reply By: eDeK<br />I added the anim &quot;ai_zombie_traverse_ground_v2_walk_alta&quot; in this line because you say dont care where:<br />{% highlight php %}
anim_zombie_barricade_ad_l,ai_zombie_base_walk_ad_win_trav_l_v1,ai_zombie_traverse_ground_v2_walk_alta{% endhighlight %}
I compile the map and the mod tools convert the anim, but the zombies dont use the anim to &quot;Appear from the ground&quot;.<br />Im using:<br />{% highlight php %}
zm_genesis_zombie.ai_bt
zm_genesis_zombie.ai_asm
zm_genesis_zombie.ai_ast

zm_genesis_zombie.ai_am{% endhighlight %}
</p>

---
<strong style="font-size: 1.4em;"><span style="text-decoration: underline;text-decoration-color: #34a7f9;"><span style="color:#34a7f9;">ModmeBot</span></span>:</strong>

<p>Reply By: mathfag<br /><blockquote><em>eDeK</em><br />I added the anim &quot;ai_zombie_traverse_ground_v2_walk_alta&quot; in this line because you say dont care where: anim_zombie_barricade_ad_l,ai_zombie_base_walk_ad_win_trav_l_v1,ai_zombie_traverse_ground_v2_walk_alta I compile the map and the mod tools convert the anim, but the zombies dont use the anim to &quot;Appear from the ground&quot;. Im using: zm_genesis_zombie.ai_bt zm_genesis_zombie.ai_asm zm_genesis_zombie.ai_ast zm_genesis_zombie.ai_am      </blockquote><br /> i meant<br />{% highlight php %}
animation_alias,anim1,anim2,anim3{% endhighlight %}
...
<p>Reply By: eDeK<br />The anim:<br />{% highlight php %}
https://www.twitch.tv/videos/338142398{% endhighlight %}
My file &quot;anim_zombie_ground_spawn.atr&quot;:<br />{% highlight php %}
share\raw\animtrees
...
My zone file:<br />{% highlight php %}
rawfile,animtrees/anim_zombie_ground_spawn.atr 
xanim,ai_zombie_traverse_ground_v2_walk_alta{% endhighlight %}
My &quot;zm_genesis_zombie.ai_am&quot;:<br />{% highlight php %}
In the botom of the file...

anim_zombie_ground,ai_zombie_traverse_ground_v2_walk_alta
void,void{% endhighlight %}
My GSC:<br />{% highlight php %}
#precache("xanim", "ai_zombie_traverse_ground_v2_walk_alta");

#using_animtree("anim_zombie_ground_spawn");{% endhighlight %}
{% highlight php %}
zm_spawner::do_zombie_rise( &amp;dracula_spawn );{% endhighlight %}
{% highlight php %}
...
<p>Reply By: eDeK<br />Thanks Mathfag, works perfect dude!<br />{% highlight php %}
https://www.twitch.tv/videos/338580327{% endhighlight %}
{% highlight php %}
% = Crash the game

" " = Works perfect.{% endhighlight %}
How can i do the risers use 3 or more anims to appear, i tried with this function but the risers only can use 2 anims:<br />{% highlight php %}
function new_spawn()
{
	while(1)
	{
