...
<p>Reply By: eDeK<br />I added the anim &quot;ai_zombie_traverse_ground_v2_walk_alta&quot; in this line because you say dont care where:<br />[CODE=php]anim_zombie_barricade_ad_l,ai_zombie_base_walk_ad_win_trav_l_v1,ai_zombie_traverse_ground_v2_walk_alta[/CODE]<br />I compile the map and the mod tools convert the anim, but the zombies dont use the anim to &quot;Appear from the ground&quot;.<br />Im using:<br />[CODE=php]zm_genesis_zombie.ai_bt<br />zm_genesis_zombie.ai_asm<br />zm_genesis_zombie.ai_ast<br /><br />zm_genesis_zombie.ai_am[/CODE]</p>

---
<strong style="font-size: 1.4em;"><span style="text-decoration: underline;text-decoration-color: #34a7f9;"><span style="color:#34a7f9;">ModmeBot</span></span>:</strong>

<p>Reply By: mathfag<br /><blockquote><em>eDeK</em><br />I added the anim &quot;ai_zombie_traverse_ground_v2_walk_alta&quot; in this line because you say dont care where: anim_zombie_barricade_ad_l,ai_zombie_base_walk_ad_win_trav_l_v1,ai_zombie_traverse_ground_v2_walk_alta I compile the map and the mod tools convert the anim, but the zombies dont use the anim to &quot;Appear from the ground&quot;. Im using: zm_genesis_zombie.ai_bt zm_genesis_zombie.ai_asm zm_genesis_zombie.ai_ast zm_genesis_zombie.ai_am      </blockquote><br /> i meant<br />[CODE=php]animation_alias,anim1,anim2,anim3[/CODE]<br />go on any line.<br /> <br />What is the zombie doing in your animation?<br /> <br />If it&#39;s the rise anim, it&#39;s defined in <span style="color:#ff6600;">_zm_spawner.gsc</span> line <span style="color:#ff6600;">3047 </span><br />You can also define it with <span style="color:#ff99cc;">level.custom_riseanim</span> as seen in line <span style="color:#ff6600;">3039</span></p>

---
<strong style="font-size: 1.4em;"><span style="text-decoration: underline;text-decoration-color: #34a7f9;"><span style="color:#34a7f9;">ModmeBot</span></span>:</strong>

<p>Reply By: eDeK<br />The anim:<br />[CODE=php]https://www.twitch.tv/videos/338142398[/CODE]<br />My file &quot;anim_zombie_ground_spawn.atr&quot;:<br />[CODE=php]share\raw\animtrees<br /><br />anim_zombie_ground_spawn<br />{ <br />ai_zombie_traverse_ground_v2_walk_alta<br />}[/CODE]<br />My zone file:<br />[CODE=php]rawfile,animtrees/anim_zombie_ground_spawn.atr <br />xanim,ai_zombie_traverse_ground_v2_walk_alta[/CODE]<br />My &quot;zm_genesis_zombie.ai_am&quot;:<br />[CODE=php]In the botom of the file...<br /><br />anim_zombie_ground,ai_zombie_traverse_ground_v2_walk_alta<br />void,void[/CODE]<br />My GSC:<br />[CODE=php]#precache(&quot;xanim&quot;, &quot;ai_zombie_traverse_ground_v2_walk_alta&quot;);<br /><br />#using_animtree(&quot;anim_zombie_ground_spawn&quot;);[/CODE]<br />[CODE=php]zm_spawner::do_zombie_rise( &amp;dracula_spawn );[/CODE]<br />[CODE=php]function dracula_spawn()<br />{        <br />    self endon(&quot;death&quot;);  <br /><br />	self AnimScripted( &quot;rise_anim&quot;, self.origin, self.angles, &quot;ai_zombie_traverse_ground_v2_walk_alta&quot; );<br /><br />	self zombie_shared::DoNoteTracks( &quot;rise_anim&quot;, &amp;zombie_utility::handle_rise_notetracks, spot );        <br />}<br /><br />[/CODE]<br />What im forgetting or doing wrong?<br />Thanks for reply.</p>

---
<strong style="font-size: 1.4em;"><span style="text-decoration: underline;text-decoration-color: #34a7f9;"><span style="color:#34a7f9;">ModmeBot</span></span>:</strong>

<p>Reply By: mathfag<br /><blockquote><em>eDeK</em><br />The anim: <a href="https://www.twitch.tv/videos/338142398">https://www.twitch.tv/videos/338142398</a> My file &quot;anim_zombie_ground_spawn.atr&quot;: share\raw\animtrees anim_zombie_ground_spawn { ai_zombie_traverse_ground_v2_walk_alta } My zone file: rawfile,animtrees/anim_zombie_ground_spawn.atr xanim,ai_zombie_traverse_ground_v2_walk_alta My &quot;zm_genesis_zombie.ai_am&quot;: In the botom of the file... anim_zombie_ground,ai_zombie_traverse_ground_v2_walk_alta void,void My GSC: #precache(&quot;xanim&quot;, &quot;ai_zombie_traverse_ground_v2_walk_alta&quot;); #using_animtree(&quot;anim_zombie_ground_spawn&quot;); zm_spawner::do_zombie_rise( &amp;dracula_spawn ); function dracula_spawn() { self endon(&quot;death&quot;); self AnimScripted( &quot;rise_anim&quot;, self.origin, self.angles, &quot;ai_zombie_traverse_ground_v2_walk_alta&quot; ); self zombie_shared::DoNoteTracks( &quot;rise_anim&quot;, &amp;zombie_utility::handle_rise_notetracks, spot ); } What im forgetting or doing wrong? Thanks for reply.  </blockquote><br /> Ditch the drakula_spawn function and add this somewhere in function main<br />[CODE=php]level.custom_riseanim = %ai_zombie_traverse_ground_v2_walk_alta;<br />[/CODE]<br />Never done risers before. I&#39;ll try it tomorrow, it&#39;s late now.<br />If it doesn&#39;t work put the anim in quotation marks instead of %<br /> <br />The code seems pretty solid (_zm_spawner.gsc lines 3037+)<br />[CODE=php]	if( isdefined( level.custom_riseanim ) )<br />	{<br />		self AnimScripted( &quot;rise_anim&quot;, self.origin, spot.angles, level.custom_riseanim );	<br />	}<br />	else if( isdefined( level.custom_rise_func ) ) <br />	{<br />		self [[ level.custom_rise_func ]]( spot );<br />	}		<br />	else<br />	{<br />		self AnimScripted( &quot;rise_anim&quot;, self.origin, spot.angles, &quot;ai_zombie_traverse_ground_climbout_fast&quot; );		<br />	}[/CODE]</p>

---
<strong style="font-size: 1.4em;"><span style="text-decoration: underline;text-decoration-color: #34a7f9;"><span style="color:#34a7f9;">ModmeBot</span></span>:</strong>

<p>Reply By: eDeK<br />Thanks Mathfag, works perfect dude!<br />[CODE=php]https://www.twitch.tv/videos/338580327[/CODE]<br />[CODE=php]% = Crash the game<br /><br />&quot; &quot; = Works perfect.[/CODE]<br />How can i do the risers use 3 or more anims to appear, i tried with this function but the risers only can use 2 anims:<br />[CODE=php]function new_spawn()<br />{<br />	while(1)<br />	{<br />		<br />	    if( RandomInt( 100 ) &gt; 52.3 )<br />        {<br />		    level.custom_riseanim = &quot;ai_zombie_traverse_ground_v2_walk_alta&quot;;<br />	    }<br /><br />	    else<br />	    {	    		<br />	        level.custom_riseanim = &quot;ai_zombie_traverse_ground_climbout_fast&quot;;  <br />	    }<br /><br />	    wait(1);<br />	}    <br />}[/CODE]</p>

---
<strong style="font-size: 1.4em;"><span style="text-decoration: underline;text-decoration-color: #34a7f9;"><span style="color:#34a7f9;">ModmeBot</span></span>:</strong>

<p>Reply By: Harry Bo21<br />[CODE=php]function new_spawn()<br />{<br />	while( 1 )<br />	{<br />		n_random = RandomInt( 3 );<br />	    	if ( n_random == 0 )<br />        	{<br />		    level.custom_riseanim = &quot;ai_zombie_traverse_ground_v2_walk_alta&quot;;<br />	   	}<br />		else if ( n_random == 1 )<br />	    	{	    		<br />	        	level.custom_riseanim = &quot;ai_zombie_traverse_ground_climbout_fast&quot;;  <br />	    	}<br />		else<br />	    	{	    		<br />	        	level.custom_riseanim = &quot;ai_zombie_traverse_ground_climbout_fast&quot;;  <br />	    	}<br /><br />	    wait 1;<br />	}    <br />}[/CODE]</p>
