...
<p>Thread By: The Black Death<br />In my map I have a script_model with targetname &quot;aldwych_table_urn&quot;. Before a trigger is activated I want it to be playing a looping 3d sound, and after it&#39;ll play another sound (that won&#39;t loop).<br /> <br />To achieve this I&#39;ve tried to use the functions: <br />{% highlight php %}
...
&lt;entity&gt; PlaySound(&lt;aliasname&gt;)&lt;/aliasname&gt;&lt;/entity&gt;&lt;/aliasname&gt;&lt;/entity&gt;&lt;/aliasname&gt;&lt;/entity&gt;{% endhighlight %}
...
{% endhighlight %}
 <br /> <br />And this is my code:<br />{% highlight php %}
