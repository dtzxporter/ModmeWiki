...
<p>[COLOR=rgb(204, 204, 204)]Hey all, here&#39;s some custom round numbers I made for the craic, in the same bloody style as Black Ops 3 made to resemble various styles from past games. Open to making more styles in future if I have time and there is enough interest or any requests. <br /><br />Each image is [/COLOR][COLOR=rgb(84, 172, 210)]84[/COLOR][COLOR=rgb(204, 204, 204)]x[/COLOR][COLOR=rgb(84, 172, 210)]120[/COLOR][COLOR=rgb(204, 204, 204)], similar to BO3&#39;s originals, and also include the [/COLOR]<em>_act</em>[COLOR=rgb(204, 204, 204)] &amp; [/COLOR][COLOR=rgb(239, 239, 239)]<em>_glow</em>[/COLOR]<span style="color:#cccccc;">images for proper round transitions. </span><br /><br />Legacy [COLOR=rgb(204, 204, 204)]- World at War&#39;s UI and round number font.[/COLOR]<br />Morris [COLOR=rgb(204, 204, 204)]- A display font from Black Ops 1 that was also used for round numbers in some old WaW custom maps which I thought it worked well.[/COLOR]<br />Ops [COLOR=rgb(204, 204, 204)]-[/COLOR] [COLOR=rgb(204, 204, 204)]Black Ops 1&#39;s UI and round number font. [/COLOR]<br /><br /><img style="max-width: 500px;" src="https://i.imgur.com/UX2LI2P.png"><br /><br />[COLOR=rgb(26, 188, 156)]Update (12-10-2020): [/COLOR]<br /><br />[COLOR=rgb(255, 255, 255)]Afterlife [/COLOR][COLOR=rgb(204, 204, 204)]- Textures ported straight from Black Ops 2&#39;s Mob of the Dead. I thought they looked pretty neat and could work as round numbers too. <br /><br /><img style="max-width: 500px;" src="https://i.imgur.com/U3kKLCL.png">[/COLOR]<br /><br /><span style="color:#cccccc;">[COLOR=rgb(204, 204, 204)]I also made many small adjustments across the board to ensure each character&#39;s size is more consistent, as well as some further visual updates to some. The downloads have been updated accordingly. I actually got around to re-taking the in-game screenshots with the correct round widget scale. Current screenshots are now much more representative of how they&#39;ll look for anyone who downloads them. </span>[/COLOR]<br /><br />[COLOR=rgb(26, 188, 156)]Update (17-10-2020):[/COLOR]<br /><br />Broken Earth [COLOR=rgb(204, 204, 204)]- I thought I might as well complete the set of games from which the inspiration for all of these is derived, so here&#39;s Black Ops 2&#39;s UI &amp; round number font too. For the craic, I also included a crossed zero alternative as I felt like it fit for this style. <br /><br /><img style="max-width: 500px;" src="https://i.imgur.com/XBGiblz.png">[/COLOR]<br /><br />[COLOR=rgb(26, 188, 156)]Update (03-11-2020):[/COLOR]<br /><br />Murderer [COLOR=rgb(204, 204, 204)]- Requested, so I quickly threw this together. Actually turned out pretty well in game. <br /><br /><img style="max-width: 500px;" src="https://i.imgur.com/qF3HaWA.png"> [/COLOR]<br /><br /><br /><span style="font-size:1.6em;">In Game Screenshots</span><br /><br />
...
[COLOR=rgb(204, 204, 204)]Download the .zip and drag &amp; drop the [/COLOR]<em>texture_assets</em>[COLOR=rgb(204, 204, 204)] folder into your BO3 root. You can double check that they&#39;ve been installed correctly by opening [/COLOR]custom_round_numbers.gdt[COLOR=rgb(204, 204, 204)] in APE and verifying that the images are showing up and there are no errors. <br /><br />Next up add the following lines to the .zone file of any map you want to use them in: [/COLOR]<br /><br />{% highlight php %}
...
image,uie_t7_zm_hud_rnd_nmbr9_glow{% endhighlight %}
<br />[COLOR=rgb(204, 204, 204)]Finally, you&#39;ll need to remove / comment out the existing round numbers from the asset lists in the [/COLOR]<em>zone_source</em>[COLOR=rgb(204, 204, 204)] folder. Navigate to [/COLOR]<em>Call of Duty Black Ops III\zone_source\all\assetlist</em>[COLOR=rgb(204, 204, 204)] and open two files: [/COLOR]zm_common.csv[COLOR=rgb(204, 204, 204)] &amp; [/COLOR]zm_levelcommon.csv[COLOR=rgb(204, 204, 204)] (to be honest, I&#39;m not sure whether you actually need to edit both but this is what worked for me anyways). You can either remove the named list of images or use the code below rather than commenting them manually. Of course I recommend you create backups of both files before editing them.[/COLOR]<br /><br />{% highlight php %}
# image,uie_t7_zm_hud_rnd_nmbr0
# image,uie_t7_zm_hud_rnd_nmbr0_act
# image,uie_t7_zm_hud_rnd_nmbr0_glow
# image,uie_t7_zm_hud_rnd_nmbr1
...
image,uie_t7_zm_hud_rnd_mrk5act{% endhighlight %}
</p>
