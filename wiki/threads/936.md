...
<p>Reply By: easyskanka<br />Did exactly as you said but after compiling i get the error:<br /> <br />Uninitialized local variable &#39;Brutus&#39;<br /> <br />doesn&#39;t like this line?<br /> <br /> <br />{% highlight php %}
brutus thread brutus::arena_spawn_brutus();{% endhighlight %}
</p>
...
#using scripts\zm\zm_gulag_test;{% endhighlight %}
</p>
...
function brutus_doo_dah()
{
	...
	trig waittill("trigger",player);
	brutus_spawner =  struct::get("brutus_arena_spawn","targetname");
	for(i=0;i&lt;level.brutuses;i++) {="" brutus_spawner="" thread="" brutus::arena_spawn_brutus();="" wait(5);="" time="" between="" brutus="" spawns="" }="" iprintlnbold("1");="" doors="GetEntArray("brutus_door","targetname");" level="" waittill("brutus_down");="" iprintlnbold("2");="" for(i=""&gt;&lt;/level.brutuses;i++)&gt;&lt;doors.size;i++) {="" time="2;" 2="" seconds="" for="" door="" to="" move="" doors[i]="" movez(-500,time);="" -500="" is="" units="" to="" move="" on="" z="" axis="" }="" wait(time);="" for(i=""&gt;&lt;/doors.size;i++)&gt;&lt;doors.size;i++) {="" doors[i]="" delete();="" }="" iprintlnbold("3");=""&gt;&lt;/doors.size;i++)&gt;{% endhighlight %}
...
<p>Reply By: Zombeast250<br />i changed all 3 places to  iprintlnbold( &quot;1&quot; );  iprintlnbold( &quot;2&quot; );     iprintlnbold( &quot;3&quot; );<br />now i have the message when he spawns it says 1 but 2 and 3 dont work and the door does nothing<br />{% highlight php %}
IPrintLnBold("1");{% endhighlight %}
</p>
...
for(i=0;i&lt;level.brutuses;i++) {="" brutus_spawner="" thread="" brutus::arena_spawn_brutus();="" wait(5);="" time="" between="" brutus="" spawns=""&gt;&lt;/level.brutuses;i++)&gt;{% endhighlight %}
