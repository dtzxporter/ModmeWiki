...
{% endhighlight %}
<br />Next, the only change I made to the max ammo default script was around line 112ish, where I got the code from Abnormal202.<br /><br />{% highlight php %}
...
<br /><br /><br /><br /><br />TLDR:<br />Everything here works, but only on SoE. On maps without a shield, the map crashes on the loading screen. On Chronicles maps, the max ammo, carpenter, and widows wine scripts do not function.<br /><br />Here is what my zone file looks like:<br />{% highlight php %}
&gt;mode,zm
&gt;type,common
