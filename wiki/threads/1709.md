...
<p>Thread By: m1cke<br />{% highlight php %}
...
Exception while parsing (c:\program files (x86)\steam\steamapps\common\call of duty black ops iii\deffiles\xmodel.awi): reason: Parse Error: invalid float default value &#39;0.008&#39; at line(9) "float 0.008 0 32 LodColorPriority"{% endhighlight %}
