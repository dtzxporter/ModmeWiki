...
<p>Thread By: TCM<br />I know this has probably been asked before but for some reason I am trying to use <br /> <br />{% highlight php %}
player PlayLocalSound("purchase_accept");{% endhighlight %}
...
thread playwhenfinished();{% endhighlight %}
 <br /> <br />{% highlight php %}
...
<p>Reply By: TCM<br />This is what I have right now doing that<br /> <br /> <br />{% highlight php %}
