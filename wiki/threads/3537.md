...
{% endraw %}{% endhighlight %}
<br />Next, lets make the perk jingle work! Go to [COLOR=rgb(235, 107, 86)]&quot;Black Ops 3 Root/usermaps/YOURMAP/sound/zoneconfig&quot;[/COLOR] and open up your .scz file. Under this:<br /><br />{% highlight php %}{% raw %}
{
    "Type" : "ALIAS",
    "Name" : "user_aliases",
