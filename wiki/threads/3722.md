...
<p>check if the sound file is .wav and if the frequence is 48000Hz in audacity like that for each sound <a href="{{ '/wiki/threads/assets/a.1259.PNG' | relative_url }}">Download "Capture.PNG"</a></p>
