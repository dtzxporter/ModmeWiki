...
cryo 								= "i_cryo_shader"{% endhighlight %}
...
<p>Reply By: TCM<br /><img style="max-width: 500px;" src="https://i.imgur.com/XpkwQiv.png"><br /> <br />Also get this<br /> <br />{% highlight php %}
...
ERROR: no files for filespec: cryo\cryo_ready.wav{% endhighlight %}
</p>
...
<p>Reply By: Abnormal202<br />I just realized in the instructions I accidentally wrote:<br />{% highlight php %}
snails_pace 						= "i_cryo_shader"{% endhighlight %}
 <br />that should be <br />{% highlight php %}
cryo 						= "i_cryo_shader"{% endhighlight %}
</p>
...
<p>Reply By: TCM<br /><blockquote><em>Abnormal202</em><br />I just realized in the instructions I accidentally wrote: snails_pace = &quot;i_cryo_shader&quot;   that should be  cryo = &quot;i_cryo_shader&quot;</blockquote><br /> <br /> <br />I already had this<br /> <br />{% highlight php %}
cryo 								= "i_cryo_shader"{% endhighlight %}
...
<p>Reply By: TCM<br /><blockquote><em>Abnormal202</em><br />I just realized in the instructions I accidentally wrote: snails_pace = &quot;i_cryo_shader&quot;   that should be  cryo = &quot;i_cryo_shader&quot;</blockquote><br /> <br />{% highlight php %}
...
^1Effect &#39;fx/frostbite/cryo_slide_freeze.efx&#39; not found
  fx:frostbite/cryo_slide_freeze.efx
    csv:abnormal202_cryo_slide_soda.zpkg
      csv:zone_source/zm_trop.zone{% endhighlight %}
</p>
...
<p>Reply By: TCM<br /><blockquote><em>Abnormal202</em><br />okay v1.2 should have it. Let me know if there are any other issues</blockquote><br /> <br />I added it and now I get this<br />I am not sure what it all means since I didn&#39;t add anything but yours<br /> <br />{% highlight php %}
...
{% highlight php %}
CoD.Zombie.CommonHudRequire(){% endhighlight %}
{% highlight php %}
CoD.CustomPerkIcons = InheritFrom(LUI.UIElement){% endhighlight %}
{% highlight php %}
function CoD.CustomPerkIcons.return_array(){% endhighlight %}
{% highlight php %}
local array ={% endhighlight %}
{% highlight php %}
{{% endhighlight %}
{% highlight php %}
quick_revive = "i_t7_specialty_quickrevive",{% endhighlight %}
{% highlight php %}
doubletap2 = "i_t7_specialty_doubletap2",{% endhighlight %}
{% highlight php %}
juggernaut = "i_t7_specialty_armorvest",{% endhighlight %}
{% highlight php %}
sleight_of_hand = "i_t7_specialty_fastreload",{% endhighlight %}
{% highlight php %}
dead_shot = "i_t7_specialty_deadshot",{% endhighlight %}
{% highlight php %}
phdflopper = "i_t7_specialty_phdflopper",{% endhighlight %}
{% highlight php %}
marathon = "i_t7_specialty_staminup",{% endhighlight %}
{% highlight php %}
additional_primary_weapon = "i_t7_specialty_additionalprimaryweapon",{% endhighlight %}
{% highlight php %}
tombstone = "i_t7_specialty_tombstone",{% endhighlight %}
{% highlight php %}
whoswho = "i_t7_specialty_whoswho",{% endhighlight %}
{% highlight php %}
electric_cherry = "i_t7_specialty_electriccherry",{% endhighlight %}
{% highlight php %}
vultureaid = "i_t7_specialty_vultureaid",{% endhighlight %}
{% highlight php %}
widows_wine = "i_t7_specialty_widowswine"{% endhighlight %}
{% highlight php %}
cryo = "i_cryo_shader"{% endhighlight %}
{% highlight php %}
}{% endhighlight %}
{% highlight php %}
return array{% endhighlight %}
{% highlight php %}
end{% endhighlight %}
...
a question that has nothing to do with this.{% endhighlight %}
{% highlight php %}
is you {% endhighlight %}
