...
maps\_zombiemode_bowie::bowie_init();{% endhighlight %}
<br /><br /><br /><br /><br /><br /><br /><br /><br /><span style="text-decoration: underline"><strong><span style="color:#ff6633;"># 2. Changes to zombiemode_dig_sites.gsc</span></strong></span><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />{% highlight php %}
# change this :
...
<br /><br /><br /><br /><br /><br /><br />{% highlight php %}
# Tick the scripts in launcher, recompile map, build mod ( do this TWICE ) and run{% endhighlight %}
