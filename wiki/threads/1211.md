...
<p>Reply By: VoltiK<br />I have taken a look at your script and amended it. I have made your papunlock function into a while(1) and called the thread on the player after each trigger has been used and points have been given.<br /> <br />{% highlight php %}
&lt;sub&gt;function papswitch1()&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;{ &lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht1 = GetEnt("switcht1", "targetname"); &lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; //Declare item model&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switchm1 = GetEnt("switchm1", "targetname");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; //Set Hintstring for item trigger&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht1 SetHintString("Hold &amp;&amp;1 To Activate Switch");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; //Remove hand icon for item trigger&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht1 SetCursorHint("HINT_NOICON");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; //Wait for player to action item trigger&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht1 waittill("trigger", player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; level.pswitches ++;&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; player.score += 100;&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;//Added script to check progession on switches..&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; thread papunlock(player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;switcht1 Delete();&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switchm1 Delete();&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;}&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;function pswitch2()&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;{&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht2 = GetEnt("switcht2", "targetname");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht2 SetHintString("Hold &amp;&amp;1 To Activate Switch");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht2 SetCursorHint("HINT_NOICON");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht2 waittill("trigger", player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; level.pswitches ++;&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; player.score += 100;&lt;/sub&gt;{% endhighlight %}
...
&lt;sub&gt; thread papunlock(player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;switcht2 Delete(); &lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;}&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;function papswitch3()&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;{&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht3 = GetEnt("switcht3", "targetname");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht3 SetHintString("Hold &amp;&amp;1 To Activate Switch");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht3 SetCursorHint("HINT_NOICON");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht3 waittill("trigger", player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; level.pswitches ++;&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; player.score += 100;&lt;/sub&gt;{% endhighlight %}
...
&lt;sub&gt; thread papunlock(player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;switcht3 Delete(); &lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;}&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;function papswitch4()&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;{&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht4 = GetEnt("switcht4", "targetname");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht4 SetHintString("Hold &amp;&amp;1 To Activate Switch");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht4 SetCursorHint("HINT_NOICON");&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switcht4 waittill("trigger", player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; level.pswitches ++;&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; player.score += 100;&lt;/sub&gt;{% endhighlight %}
...
&lt;sub&gt; thread papunlock(player);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;switcht4 Delete(); &lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;}&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;function papunlock(player)&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;{&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; while(1)&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; {&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; self waittill(level.pswitches &gt;= 4);&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; if(level.pswitches == 4)&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; {&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switchdoor = GetEntArray("easter_egg_door","targetname"); //door parts array&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; switchdoor Delete();&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; }&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; break;&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt; }&lt;/sub&gt;{% endhighlight %}
{% highlight php %}
&lt;sub&gt;}&lt;/sub&gt;{% endhighlight %}
...
{ 
  if(level.pswitches == 4)	
  {
     ...
     for(i=0;i&lt;switchdoor.size;i++) {="" switchdoor[i]="" delete();="" }="" }=""&gt;&lt;/switchdoor.size;i++)&gt;{% endhighlight %}
</p>
