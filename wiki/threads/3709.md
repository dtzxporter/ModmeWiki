...
<p><img style="max-width: 500px;" src="{{ '/wiki/threads/assets/1160.png' | relative_url }}"><br />How does one fix this? Is it from overlapping brushes or is it from too many vertices in my map?</p>
...
<p><blockquote><img style="max-width: 500px;" src="{{ '/wiki/threads/assets/1160.png' | relative_url }}"><br />How does one fix this? Is it from overlapping brushes or is it from too many vertices in my map?<br /></blockquote><br />How did you end up fixing this? Just too many verts yeah?</p>
